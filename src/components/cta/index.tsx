...
const CTA = () => {
  return (
    <section className="w-full h-[400px] lg:h-[499px] flex items-center justify-center px-3 bg-[url('/images/svg/cta.svg')] bg-no-repeat bg-cover">
        <div className="max-w-[500px] w-full  text-[#FFFFFF] flex flex-col gap-7 items-center justify-center font-bold text-xl  lg:text-[24px] lg:leading-[25px] text-center">
            <QuoteSvg />
            <p className="w-full">
